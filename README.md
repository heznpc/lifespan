...
Research Program: 2 (Epistemic Failure and Correction) — companion to ploidy; bridges to Program 4 (AI-Mediated Accumulation)
Status: Concept note
Relationship to other work: Companion in Program 2 (anchor: ploidy); bridge between Programs 2 and 4. Companion software/systems paper: [heznpc/ploidy-research](https://github.com/heznpc/ploidy-research).
